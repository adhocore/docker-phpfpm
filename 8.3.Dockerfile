FROM php:8.3.0alpha2-fpm-alpine3.17
...
# copy from existing
#COPY --from=adhocore/phpfpm:8.3 /usr/local/lib/php/extensions/no-debug-non-zts-20220829/*.so /usr/local/lib/php/extensions/no-debug-non-zts-20220829/
