...
ENV \
  ...
  PECL_EXTENSIONS_FUTURE="apcu ev event hrtime imagick lua rdkafka ssh2-1.2 xlswriter yaf" \
  PECL_EXTENSIONS="ast ds igbinary lzf memcached mongodb msgpack oauth pcov psr redis uuid xdebug yaml" \
